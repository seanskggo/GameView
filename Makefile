...
testGameView.o: testGameView.c GameView.h Map.h Places.h Queue.h Game.h

testHunterView: testHunterView.o testUtils.o HunterView.o GameView.o Map.o Places.o Queue.o
testHunterView.o: testHunterView.c HunterView.h GameView.h Map.h Places.h Queue.h Game.h

testDraculaView: testDraculaView.o testUtils.o DraculaView.o GameView.o Map.o Places.o Queue.o
testDraculaView.o: testDraculaView.c DraculaView.h GameView.h Map.h Places.h Queue.h Game.h

testMap: testMap.o Map.o Places.o Queue.o
testMap.o: testMap.c Map.h Places.h Queue.h
